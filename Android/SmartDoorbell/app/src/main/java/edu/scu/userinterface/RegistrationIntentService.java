...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.d("BBBBB username", username);
        Log.d("BBBBB password", password);
     ...
     */
    private void sendRegistrationToServer(String token, String username, String password) {
        // Add custom implementation, as needed.
        Log.d("AAAAAAAAAAAAAAAAAAAA sendRegistrationToServer", token);
        Log.d("AAAAAAAAAAAAAAAAAAAA username", username);
        Log.d("AAAAAAAAAAAAAAAAAAAA password", password);
    }
